...
class AKShareFetcher:
    ...
    def __init__(self):
        ...
        self._fund_list_cache_time: datetime | None = None
    ...
    async def search_funds(self, query: str, limit: int = 20) -> list[FundSearchResult]:
        ...
        def _search() -> list[FundSearchResult]:
            ...
            try:
                mask = df[code_col].astype(str).str.contains(query, case=False, na=False) | df[name_col].astype(
                    str
    ...
    async def get_fund_info(self, fund_code: str) -> FundBasicInfo | None:
        ...
        def _get_info() -> FundBasicInfo | None:
            try:
    ...
    async def get_holdings_disabled(self, fund_code: str) -> FundHoldings | None:
        """ORIGINAL CODE - DISABLED."""

        def _get_holdings() -> FundHoldings | None:
            try:
                # Get fund name
...
# Singleton instance
_akshare_fetcher: AKShareFetcher | None = None
