...
class MetricsCalculator:
    ...
    def calculate_metrics(
        ...
        latest_nav = df[df["date"] == latest_date]["nav"].values[0]
    ...
    def _calculate_inception_return(self, df: pd.DataFrame) -> Optional[float]:
    ...
    def _calculate_sharpe_ratio(self, df: pd.DataFrame) -> Optional[float]:
        """
