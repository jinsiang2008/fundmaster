...
class InvestmentPurpose(StrEnum):
    """Investment purpose."""
...
class UserProfile(BaseModel):
    ...
    class Config:
        json_schema_extra = {"example": {"risk_level": "stable", "purpose": "savings", "horizon": "short"}}
...
class ChatSession(BaseModel):
    ...
    user_profile: UserProfile | None = Field(default=None, description="用户画像")
...
class ChatRequest(BaseModel):
    ...
    session_id: str | None = Field(default=None, description="会话ID，首次对话可不传")
    fund_code: str | None = Field(default=None, description="基金代码，创建新会话时必传")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "user_profile": {"risk_level": "stable", "purpose": "savings", "horizon": "medium"},
            }
        }
